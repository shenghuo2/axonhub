...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[2] = &sqlgraph.Node{
		...
		Type: "Announcement",
		Fields: map[string]*sqlgraph.FieldSpec{
			announcement.FieldCreatedAt: {Type: field.TypeTime, Column: announcement.FieldCreatedAt},
			announcement.FieldUpdatedAt: {Type: field.TypeTime, Column: announcement.FieldUpdatedAt},
			announcement.FieldDeletedAt: {Type: field.TypeInt, Column: announcement.FieldDeletedAt},
...
func (f *APIKeyFilter) WhereHasAnnouncements() {
...
func (f *APIKeyFilter) WhereHasAnnouncementsWith(preds ...predicate.Announcement) {
...
// addPredicate implements the predicateAdder interface.
func (_q *AnnouncementQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the AnnouncementQuery builder.
func (_q *AnnouncementQuery) Filter() *AnnouncementFilter {
	return &AnnouncementFilter{config: _q.config, predicateAdder: _q}
}
...
// WhereID applies the entql int predicate on the id field.
func (f *AnnouncementFilter) WhereID(p entql.IntP) {
	f.Where(p.Field(announcement.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *AnnouncementFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(announcement.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *AnnouncementFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(announcement.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql int predicate on the deleted_at field.
func (f *AnnouncementFilter) WhereDeletedAt(p entql.IntP) {
...
func (f *AnnouncementFilter) WhereHasAPIKeys() {
...
func (f *AnnouncementFilter) WhereHasAPIKeysWith(preds ...predicate.APIKey) {
